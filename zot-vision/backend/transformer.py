...
# CONFIG
# ──────────────────────────────────────────────
KAGGLE_DATASET = "vinscent/firefighter-hud-dataset"
DATASET_DIR    = os.path.join(os.path.dirname(__file__), "..", "datasets")
#IMAGES_DIR     = os.path.join(DATASET_DIR, "images")
IMAGES_DIR      = "/Users/vincentpham/Desktop/Dataset"
LABELS_FILE    = os.path.join(DATASET_DIR, "results", "labels.json")
...
def load_samples(json_file, images_dir):
    import json
...
class CNNViTHybrid(nn.Module):
    ...
    def __init__(
        ...
        self.cnn = EfficientNet.from_name(efficientnet_variant)
